...
public class UIController : MonoBehaviour
{
    ...
    {
        // Мы по-прежнему НЕ трогаем иконки инвентаря. Эти строки остаются закомментированными.
        /*
        ...
        */
        ...
        // А вот счетчик собранных на уровне предметов мы ОБНУЛЯЕМ.
        collectedOnLevel = 0;

        // И сразу обновляем UI, чтобы он показал "0 / ..."
        UpdateInventoryCountUI();

        Debug.Log("[UIController] Счетчик предметов уровня сброшен. Инвентарь сохранен.");
    }
